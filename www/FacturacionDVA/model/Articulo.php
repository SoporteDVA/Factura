<?php
	...
	class articulo{
		...
		public function Registrar($idcategoria, $idunidad_medida, $nombre, $descripcion, $imagen,$impuesto){
			global $conexion;
			$sql = "INSERT INTO articulo(idcategoria, idunidad_medida, nombre, descripcion, imagen, estado,impuesto)
						VALUES($idcategoria, $idunidad_medida, '$nombre', '$descripcion', '$imagen', 'A', '$impuesto')";
