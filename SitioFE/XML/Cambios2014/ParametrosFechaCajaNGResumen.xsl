...
<xsl:stylesheet xmlns:a="http://tempuri.org/" exclude-result-prefixes="a soap" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/" version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/">
		<html>
			...
			<xsl:choose>
				<xsl:when test="BitacoraNGResumenFechaCajaOutput">
					<xsl:for-each select="BitacoraNGResumenFechaCajaOutput">
	...
	<xsl:template name="Consulta">
		<form action="Transaccion.aspx" method="post">
			<input type="hidden" name="Transaccion" value="BitacoraNGResumenFechaCaja"/>
			<input type="hidden" name="ServidorSTX" value="infoware.STX.Gestion"/>
			<input type="hidden" name="Filtro" value="XML/Cambios2014/ParametrosFechaCajaNGResumen.xsl"/>
			<br/>
			<table align="center" width="500" border="0">
				<tr>
					<td width="50%" align="center">
						<font class="tituloAzulClaro">Bitacora de Pagos por Caja y rango de Fechas</font>
					</td>
				</tr>
			</table>
			<br/>
			...
			<table class="tabla" align="center">
				<tr>
					<td class="etiqueta">Seleccione la Caja :</td>
	...
	<xsl:template name="PagosBIT">
		<div align="center">
			<font class="tituloAzulClaro">Detalle de transacciones Generales por Caja</font>
		</div>
		...
		<table id="testTable" class="tabla" align="center" width="900">
			<thead>
				<tr class="etiqueta">
