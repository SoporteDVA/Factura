...
<xsl:stylesheet xmlns:a="http://tempuri.org/" exclude-result-prefixes="a soap" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/" version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template name="Consulta">
		<form action="Transaccion.aspx" method="post">
			...
			<input type="hidden" name="Filtro" value="XML/Cambios2014/ParametrosNGResumenFechaCajaGrupo.xsl"/>
			<br/>
			<table align="center" width="500" border="0">
				<tr>
					<td width="50%" align="center">
						<font class="tituloAzulClaro">Bitacora de Pagos por Sucursal Propia y Agrupada por Caja INS</font>
					</td>
				</tr>
			</table>
			<br/>
	...
	<xsl:template name="PagosBIT">
		...
		<div align="center">
			<font class="tituloAzulClaro">Agrupacion de Pagos por Caja  en la Oficina o Sucursal Actual</font>
		</div>
