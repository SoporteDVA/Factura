...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="AgregarOficinaOutput">
		...
		<form action="Transaccion.aspx">
			...
			<br/>
			<div align="center">
				<input name="BotonSalvar" type="submit" value="      Salvar      " onclick="cargar(this,'Transaccion.aspx?Transaccion=DVAAgregarOficinas&amp;Filtro=~/XML/Gestion/AgregarOficina.xsl','Transaccion')"/>
