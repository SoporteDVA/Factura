                    ...
                    <table border = "0">
                        <tbody>
                                ...
                                <td width = "50%">
                                    <p align = "center">
                                        <font class = "tituloAzulClaro">
                                            <strong>Gestión y Control de Cierre Cajas Masivo</strong>
                                        </font>
                                    </p>
                                </td>
                            </tr>
                            <xsl:choose>
                                ...
                                <xsl:when test = "ConsultaCierreCajasFechasOutput">
                                    <xsl:for-each select = "ConsultaCierreCajasFechasOutput">
                                        <xsl:call-template name = "Encabezado"/>
                                    </xsl:for-each>
                                </xsl:when>
                                ...
                                <xsl:when test = "ConsultaCierreCajasFechasFault">
                                    <xsl:for-each select = "ConsultaCierreCajasFechasFault">
                                ...
                                <xsl:when test = "Cierre_Masivo_CajasOutput">
                                    <xsl:for-each select = "Cierre_Masivo_CajasOutput">
                                        <xsl:call-template name = "Encabezado"/>
                                    </xsl:for-each>
                                </xsl:when>
                                <xsl:otherwise>
    ...
    <xsl:template name = "EncabezadoVacias">
        <div align = "center">
            ...
            <input
                ...
                type = "button"
                value = "      «««« Otra Consulta     "
                onclick = "cargar(this,'ComponerXSL.aspx?Transaccion=ConsultaCierreCajasFechas&amp;Accion=Todas&amp;Estado=1&amp;ServidorSTX=infoware.STX.Gestion&amp;Filtro=~/XML/CierreMasivoCajas/ConsultaCierreCajasFechaMasivo.xsl','Transaccion')"/>
        </div>
    </xsl:template>
