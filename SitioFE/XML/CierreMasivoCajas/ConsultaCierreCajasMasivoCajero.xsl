...
<xsl:stylesheet
    ...
    <xsl:template match = "/">
        <html>
            <head>
                <title>Gestión y Control de Cierres de Caja Masivo</title>
                <script
                ...
                <script language = "javascript">
                    ...
                    document.forms[0].Fecha_Cierre.value = ddMMYYYY_to_YYYYMMdd(document.forms[0].FechaPara.value);
            ...
            <body>
                    ...
                    <table border = "0">
                        <tbody>
                                ...
                                <td width = "50%">
                                    <p align = "center">
                                        <font class = "tituloAzulClaro">
                                            <strong>Gestión y Control de Cierre Cajas Completo por Cajero</strong>
                                        </font>
                                    </p>
                                </td>
                            </tr>
                            <xsl:choose>
                                ...
                                <xsl:when test = "ConsultaCierreCajasFechasCajeroOutput">
                                    <xsl:for-each select = "ConsultaCierreCajasFechasCajeroOutput">
                                        <xsl:call-template name = "Encabezado"/>
                                    </xsl:for-each>
                                </xsl:when>
                                ...
                                <xsl:when test = "ConsultaCierreCajasFechasCajeroFault">
                                    <xsl:for-each select = "ConsultaCierreCajasFechasCajeroFault">
                                        <xsl:call-template name = "EncabezadoVacias"/>
                                    </xsl:for-each>
                                </xsl:when>
                                ...
                                <xsl:when test = "Cierre_Masivo_CajasCajeroOutput">
                                    <xsl:for-each select = "Cierre_Masivo_CajasCajeroOutput">
                                        <xsl:call-template name = "Encabezado"/>
                                    </xsl:for-each>
                                </xsl:when>
                ...
                <xsl:choose>
                    ...
                    <xsl:when test = "Cierre_Masivo_CajasCajeroOutput">
                        <xsl:for-each select = "Cierre_Masivo_CajasCajeroOutput">
                            <xsl:call-template name = "ResumenCajasMasivas"/>
                        </xsl:for-each>
                    </xsl:when>
					<xsl:when test = "Cierre_Masivo_CajasCajeroFault">
                                    <xsl:call-template name = "MostrarMensaje">
                                        <xsl:with-param name = "Mensaje" select = "Cierre_Masivo_CajasCajeroFault/Mensaje"/>
                                    </xsl:call-template>
                                </xsl:when>
                </xsl:choose>
            </body>
    ...
    <xsl:template name = "EncabezadoVacias">
        <div align = "center">
            <table
                class = "tablaDetalle"
                align = "center"
            ...
            <input
                ...
                type = "button"
                value = "      «««« Otra Consulta     "
                onclick = "cargar(this,'ComponerXSL.aspx?Transaccion=ConsultaCierreCajasFechas&amp;Accion=Todas&amp;Estado=1&amp;ServidorSTX=infoware.STX.Gestion&amp;Filtro=~/XML/CierreMasivoCajas/ConsultaCierreCajasFechaMasivoCajero.xsl','Transaccion')"/>
        </div>
    </xsl:template>
        ...
        <p>
            <form action = "Transaccion.aspx" method = "post">
                <input
                    name = "Transaccion"
                    type = "hidden"
                    value = "Cierre_Masivo_CajasCajero"/>
                <input
                    name = "Filtro"
                    type = "hidden"
                    value = "XML/CierreMasivoCajas/ConsultaCierreCajasMasivoCajero.xsl"/>
                <input
                    type = "hidden"
                    name = "ServidorSTX"
                ...
                <p>
                    <div align = "center">
                        <input
                            ...
                            class = "button_red"
                            type = "submit"
                            value = "      Generar Cierre Completo     "/>
                        <input
                            name = "BtnCerrar"
                            class = "button_gris"
                            type = "button"
                            value = "      «««« Otro Dia     "
                            onclick = "cargar(this,'ComponerXSL.aspx?Transaccion=ConsultaCierreCajasFechasCajero&amp;Accion=Todas&amp;Estado=1&amp;ServidorSTX=infoware.STX.Gestion&amp;Filtro=~/XML/CierreMasivoCajas/ConsultaCierreCajasFechaMasivoCajero.xsl','Transaccion')"/>
                    </div>
                </p>
            </form>
        </p>
            ...
            <tbody>
                ...
                <tr class = "encabezado">
                    ...
                    <td align = "center">
                        <img
                            hspace = "0"
                            src = "imagenes/ConRTV.jpg"
                            align = "baseline"
                            border = "0"
                            alt = "Pagos Sin RTV a Marchamos"/>
                    </td>
                    <td align = "center">
                        <img
                            hspace = "0"
                            src = "imagenes/auto.gif"
                            align = "baseline"
                            border = "0"
                            alt = "Pagos Temporales"/>
                    </td>
                    <td align = "center">
                        <img
                            hspace = "0"
                            src = "imagenes/SuVida.jpg"
                            align = "baseline"
                            border = "0"
                            alt = "Pagos SuVida"/>
                    </td>
                    ...
                    <td align = "center">
                        <img
                            hspace = "0"
                            src = "imagenes/Asis.gif"
                            align = "baseline"
                            border = "0"
                            alt = "Pagos Asistencia"/>
                    </td>
                    <td align = "center">
                        <img
                            hspace = "0"
                            src = "imagenes/Cobertura.gif"
                            align = "baseline"
                            border = "0"
                            alt = "Pagos Cobertura"/>
                    </td>
                    <td align = "center">
                        <img
                            hspace = "0"
                            src = "imagenes/Proteccion.gif"
                            align = "baseline"
                            border = "0"
                            alt = "Pagos Proteccion"/>
                    </td>
                    <td align = "center">
                        <img
                            hspace = "0"
                            src = "imagenes/vwicn038.gif"
                            align = "baseline"
                            border = "0"
                            alt = "Con Problemas"/>
                    </td>
                    ...
                    <td align = "center">
                        <img
                            hspace = "0"
                            src = "imagenes/vwicn132.gif"
                            align = "baseline"
                            border = "0"
                            alt = "Comprobantes Sin Imprimir"/>
                    </td>
                    <td align = "center">
                        <img
                            hspace = "0"
                            src = "imagenes/vwicn071.gif"
                            align = "baseline"
                            border = "0"
                            alt = "Sin Conciliar"/>
                    </td>
                                ...
                                <xsl:if test = "PagosTotales &gt; 0">
                                    <a>
                                        <xsl:attribute name = "href">
                                            Transaccion.aspx?Transaccion=CajaConsultaPagos&amp;NumeroCaja=
                                            <xsl:value-of select = "NumeroCaja"/>
                                            &amp;Fecha=
                                            <xsl:value-of select = "FechaCaja"/>
                                            &amp;Estado=Todas&amp;ServidorSTX=infoware.STX.Gestion&amp;Filtro=XML/Cajas/CajaDetalle.xsl
                                        </xsl:attribute>
                                ...
                                <xsl:if test = "PagosExito &gt; 0">
                                    <a>
                                        <xsl:attribute name = "href">
                                            ...
                                            &amp;Fecha=
                                            <xsl:value-of select = "FechaCaja"/>
                                            &amp;Estado=PG&amp;ServidorSTX=infoware.STX.Gestion&amp;Filtro=XML/Cajas/CajaDetalle.xsl
                                        </xsl:attribute>
                                ...
                                <xsl:if test = "PagosReversados &gt; 0">
                                    <a>
                                        <xsl:attribute name = "href">
                                            ...
                                            &amp;Fecha=
                                            <xsl:value-of select = "FechaCaja"/>
                                            &amp;Estado=RV&amp;ServidorSTX=infoware.STX.Gestion&amp;Filtro=XML/Cajas/CajaDetalle.xsl
                                        </xsl:attribute>
                                ...
                                <xsl:if test = "PagosDuplicados &gt; 0">
                                    <a>
                                        <xsl:attribute name = "href">
                                            ...
                                            &amp;Fecha=
                                            <xsl:value-of select = "FechaCaja"/>
                                            &amp;Estado=DG&amp;ServidorSTX=infoware.STX.Gestion&amp;Filtro=XML/Cajas/CajaDetalle.xsl
                                        </xsl:attribute>
                                ...
                                <xsl:if test = "PagosTUR &gt; 0">
                                    <a>
                                        <xsl:attribute name = "href">
                                            ...
                                            &amp;Fecha=
                                            <xsl:value-of select = "FechaCaja"/>
                                            &amp;Estado=TUR&amp;ServidorSTX=infoware.STX.Gestion&amp;Filtro=XML/Cajas/CajaDetalle.xsl
                                        </xsl:attribute>
                                ...
                                <xsl:if test = "PagosAGV &gt; 0">
                                    <a>
                                        <xsl:attribute name = "href">
                                            ...
                                            &amp;Fecha=
                                            <xsl:value-of select = "FechaCaja"/>
                                            &amp;Estado=AGV&amp;ServidorSTX=infoware.STX.Gestion&amp;Filtro=XML/Cajas/CajaDetalle.xsl
                                        </xsl:attribute>
                                ...
                                <xsl:if test = "PagosSinRTV &gt; 0">
                                    <a>
                                        <xsl:attribute name = "href">
                                            ...
                                            &amp;Fecha=
                                            <xsl:value-of select = "FechaCaja"/>
                                            &amp;Estado=SRTV&amp;ServidorSTX=infoware.STX.Gestion&amp;Filtro=XML/Cajas/CajaDetalle.xsl
                                        </xsl:attribute>
                                ...
                                <xsl:if test = "PagosGenSinRTV &gt; 0">
                                    <a>
                                        <xsl:attribute name = "href">
                                            ...
                                            &amp;Fecha=
                                            <xsl:value-of select = "FechaCaja"/>
                                            &amp;Estado=GRTV&amp;ServidorSTX=infoware.STX.Gestion&amp;Filtro=XML/Cajas/CajaDetalle.xsl
                                        </xsl:attribute>
                                ...
                                <xsl:if test = "PagosTemporales &gt; 0">
                                    <a>
                                        <xsl:attribute name = "href">
                                            ...
                                            &amp;Fecha=
                                            <xsl:value-of select = "FechaCaja"/>
                                            &amp;Estado=TMP&amp;ServidorSTX=infoware.STX.Gestion&amp;Filtro=XML/Cajas/CajaDetalle.xsl
                                        </xsl:attribute>
                                ...
                                <xsl:if test = "PagosSuVida &gt; 0">
                                    <a>
                                        <xsl:attribute name = "href">
                                            ...
                                            &amp;Fecha=
                                            <xsl:value-of select = "FechaCaja"/>
                                            &amp;Estado=SV&amp;ServidorSTX=infoware.STX.Gestion&amp;Filtro=XML/Cajas/CajaDetalle.xsl
                                        </xsl:attribute>
                                ...
                                <xsl:if test = "PagosRespCivil &gt; 0">
                                    <a>
                                        <xsl:attribute name = "href">
                                            ...
                                            &amp;Fecha=
                                            <xsl:value-of select = "FechaCaja"/>
                                            &amp;Estado=RC&amp;ServidorSTX=infoware.STX.Gestion&amp;Filtro=XML/Cajas/CajaDetalle.xsl
                                        </xsl:attribute>
                                ...
                                <xsl:if test = "PagosAsistencia &gt; 0">
                                    <a>
                                        <xsl:attribute name = "href">
                                            ...
                                            &amp;Fecha=
                                            <xsl:value-of select = "FechaCaja"/>
                                            &amp;Estado=AC&amp;ServidorSTX=infoware.STX.Gestion&amp;Filtro=XML/Cajas/CajaDetalle.xsl
                                        </xsl:attribute>
                                ...
                                <xsl:if test = "PagosProteccion &gt; 0">
                                    <a>
                                        <xsl:attribute name = "href">
                                            ...
                                            &amp;Fecha=
                                            <xsl:value-of select = "FechaCaja"/>
                                            &amp;Estado=MP&amp;ServidorSTX=infoware.STX.Gestion&amp;Filtro=XML/Cajas/CajaDetalle.xsl
                                        </xsl:attribute>
                                ...
                                <xsl:if test = "PagosError &gt; 0">
                                    <a>
                                        <xsl:attribute name = "href">
                                            ...
                                            &amp;Fecha=
                                            <xsl:value-of select = "FechaCaja"/>
                                            &amp;Estado=PE&amp;ServidorSTX=infoware.STX.Gestion&amp;Filtro=XML/Cajas/CajaDetalle.xsl
                                        </xsl:attribute>
                                ...
                                <xsl:if test = "PagosPendientes &gt; 0">
                                    <a>
                                        <xsl:attribute name = "href">
                                            ...
                                            &amp;Fecha=
                                            <xsl:value-of select = "FechaCaja"/>
                                            &amp;Estado=PP&amp;ServidorSTX=infoware.STX.Gestion&amp;Filtro=XML/Cajas/CajaDetalle.xsl
                                        </xsl:attribute>
                                ...
                                <xsl:if test = "PagosSinImprimir &gt; 0">
                                    <a>
                                        <xsl:attribute name = "href">
                                            ...
                                            &amp;Fecha=
                                            <xsl:value-of select = "FechaCaja"/>
                                            &amp;Estado=SP&amp;ServidorSTX=infoware.STX.Gestion&amp;Filtro=XML/Cajas/CajaDetalle.xsl
                                        </xsl:attribute>
                        ...
                        <td class = "detalle">
                            <p align = "center">
                                <xsl:if test = "SinConciliar !=0">
                                    <a>
                                        <xsl:attribute name = "href">
                                            Transaccion.aspx?Transaccion=ObtenerPagosAConciliar&amp;NumeroCaja=
                                            <xsl:value-of select = "NumeroCaja"/>
                                            &amp;Fecha=
                                            <xsl:value-of select = "FechaCaja"/>
                                            &amp;Estado=Todas&amp;ServidorSTX=infoware.STX.Gestion&amp;Filtro=XML/Cajas/CajaDetalleSC.xsl
                                        </xsl:attribute>
    ...
    <xsl:template name = "ResumenCajasMasivas">
        <p>
            <table
                class = "tablaDetalle"
                align = "center"
                ...
                <tbody>
                    ...
                    <xsl:for-each select = "Resumen/Fila">
						...
						<td>
                            ...
                            <td>
                                <p align = "Left">
                                    <xsl:value-of select = "format-number(MontoTotal,'###,##0')"/>
                                </p>
                            </td>
                            <td>
                                <p align = "left">
                            ...
                            <td>
                                <p align = "center">
                                    <xsl:value-of select = "PagosExitoTotales"/>
                                </p>
                            </td>
                        </tr>
                    </xsl:for-each>
    ...
    <xsl:template name = "CierreCajasMasivas">
        <table
            class = "tablaDetalle"
            align = "center"
            border = "0">
            ...
            <tbody>
                ...
                <xsl:for-each select = "Fila[NumeroCaja&gt;0]">
                    <tr class = "detalle">
                        <td>
                            <p align = "center">
                                <xsl:value-of select = "NumeroCaja"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="file:///c:/Documents and Settings/Administrator/Desktop/Untitled3.xml" htmlbaseurl="192.168.1.9" outputurl="" processortype="saxon8" useresolver="yes"
		          profilemode="4" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath="" postprocessortype="none" postprocesscommandline="" postprocessadditionalpath="" postprocessgeneratedext=""
