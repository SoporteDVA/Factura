		...
		<html>
			...
			<body>
				...
				<p align="center">
					...
					<td width="100%">
						<font class="tituloAzulClaro">Gestion de las Notas de Credito para los Colectores del Sistema</font>
					</td>
				</p>
				<p>
				</p>
								...
								<xsl:for-each select="ConsultaColectoresOutput/Resultado/Fila">
									<tr class="detalle">
										<td>
											<p align="center">
												<a>
													<xsl:attribute name="href">Transaccion.aspx?Transaccion=ConsultaCondiciones&amp;Filtro=~/XML/WEBCondiciones/ActualizarCondiciones.xsl&amp;IDColector=<xsl:value-of select="ID"/>&amp;IDAlterno=<xsl:value-of select="IDAlterno"/></xsl:attribute>
													<xsl:value-of select="ID"/>
													<img hspace="1" src="imagenes/go.gif" align="center" border="0" alt="Administrar la Nota Credito"/>
												</a>
											</p>
										</td>
										<td>
