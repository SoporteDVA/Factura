...
<xsl:stylesheet xmlns:a="http://tempuri.org/" exclude-result-prefixes="a soap" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/" version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/">
		<html>
			<head>
				<title>Gestión de los Convenios asignados a cada colector del Sistema</title>
			...
			<body>
				...
				<p align="center">
					...
					<td width="100%">
						<font class="tituloAzulClaro">Convenios del Colector Seleccionado</font>
						<br/>
						<font class="tituloAzulClaro">Seleccione el Convenio en el que desea gestionar los Rubros o Conceptos</font>
					</td>
				</p>
				...
				<table class="tablaDetalle" align="center" border="0">
							...
							<tbody>
								<tr class="encabezado">
									<td align="center">
										<strong>Gestionar Rubros</strong>
									</td>
								...
								<xsl:for-each select="ConsultaConveniosOutput/Resultado/Fila">
									<tr class="detalle">
										<td>
											<p align="center">
												<a>
													<xsl:attribute name="href">Transaccion.aspx?Transaccion=ConsultaRubros&amp;Filtro=~/XML/WEBRubros/ConsultaRubro.xsl&amp;IDColector=<xsl:value-of select="../../ColectorID"/>&amp;IDConvenio=<xsl:value-of select="ID"/></xsl:attribute>
