...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/">
		<html>
			...
			<body>
				...
				<xsl:choose>
					<xsl:when test="ConsultaColectoresOutput">
						<xsl:for-each select="ConsultaColectoresOutput">
	...
	<xsl:template name="ConsultaColectoresOutput">
	...
	<xsl:template name="Actualizar">
		<form action="Transaccion.aspx">
			...
			<!-- -->
			<div align="center" class="tituloAzulClaro">Editar Colector</div>
			...
			<table align="center" class="tabla">
				...
				<tr>
					<td class="etiqueta">Codigo Alterno (Banco):</td>
					<td class="detalle">
						<input name="IDAlterno" value="{Resultado/Fila/IDAlterno}" size="5"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="3" class="detalle">
						<SELECT class="inputAzul" NAME="Destino">
							<option value="{Resultado/Fila/Destino}" selected="selected">
								<xsl:call-template name="Destino">
									<xsl:with-param name="CodigoD" select="normalize-space(Resultado/Fila/Destino)"/>
								</xsl:call-template>
							</option>
							<xsl:if test="normalize-space(Resultado/Fila/Destino)='0'">
								<OPTION VALUE="1">LOCAL</OPTION>
								<OPTION VALUE="2">MISPAGOS</OPTION>
							</xsl:if>
							<xsl:if test="normalize-space(Resultado/Fila/Destino)='1'">
								<OPTION VALUE="0">DVA</OPTION>
								<OPTION VALUE="2">MISPAGOS</OPTION>
							</xsl:if>
							<xsl:if test="normalize-space(Resultado/Fila/Destino)='2'">
								<OPTION VALUE="0">DVA</OPTION>
								<OPTION VALUE="1">LOCAL</OPTION>
							</xsl:if>
							<xsl:if test="normalize-space(Resultado/Fila/Destino)=''">
