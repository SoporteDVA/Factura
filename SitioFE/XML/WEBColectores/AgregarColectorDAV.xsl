...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template name="AgregarOutput">
		<form action="Transaccion.aspx">
			...
			<!-- -->
			<p>
				<div align="center" class="tituloAzulClaro">Información del Nuevo Colector BANCARIO (Intermedia)</div>
			</p>
			...
			<div align="center">
				...
				<input name="BotonSalvar" class="button_red" type="button" value="   Guardar   " onclick="if (document.forms[0].colector.value == '') alert('Debe definir un valor para el campo Colector'); else submit();"/>
