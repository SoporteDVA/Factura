		...
		<html>
			...
			<body>
				<form action="Transaccion.aspx" method="post">
					<input name="Transaccion" type="hidden" value="ConsultaCierreCajasFechas"/>
					<input name="Filtro" type="hidden" value="XML/CierreMasivoCajas/ConsultaCierreCajasMasivo.xsl"/>
					...
					<input name="Colector" value="{IDColector}" />
					<br/>
					<table align="center" width="500" border="0">
						<tr>
							<!--<td width="50%">
								<p align="center">
									<img align="baseline" src="imagenes/cmasivo.PNG" border="0" hspace="0" height="120" width="120"/>
								</p>
							</td>-->
							<td width="100%" align="center">
								<font class="tituloAzulClaro">Cierre de Nota Credito</font>
							</td>
						</tr>
					</table>
					<br/>
					<table class="tabla" align="center">
						<tr>
							<td class="etiqueta">Seleccione el dia que desea cerrar :</td>
							<td colSpan="3">
					...
					<p>
						<div align="center">
							<input name="Reporte" class="button_gris" type="button" value="Cerrar" onclick="sendForm();"/>
						</div>
					</p>
				</form>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\CierreMasivoCajas\ConsultaCierreCajasDetallado.xml" htmlbaseurl="..\CierreMasivoCajas\192.168.1.9" outputurl="" processortype="saxon8" useresolver="yes"
