		...
		<html>
			<head>
				...
				<script>function AgregarCaja(){					
						var urlImprimir='Transaccion.aspx?Transaccion=AgregarCaja&amp;Filtro=~/XML/Gestion/AgregarCaja.xsl';		 	  		    
							...
							<xsl:for-each select="ConsultaCajasOutput/Cajas/Fila">
								<tr class="detalle">
									<td>
										<p align="center">
											<a>
												<xsl:attribute name="href">Transaccion.aspx?Transaccion=ActualizarCajas&amp;Filtro=~/XML/Gestion/ActualizarCaja.xsl&amp;NumeroCaja=<xsl:value-of select="NumeroCaja"/></xsl:attribute>
