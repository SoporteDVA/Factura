...
<xsl:stylesheet xmlns:a="http://tempuri.org/" exclude-result-prefixes="a soap" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/" version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/">
		<html>
			<head>
				<title>Bitacora Lista Procesos Cargos Automaticos</title>
	...
	<xsl:template name="Consulta">
		<form action="Transaccion.aspx" method="post" target="_blank">
			...
			<input type="hidden" name="Filtro" value="XML/WEBConsultas/ParametrosNGListaProcesosCAExcel.xsl"/>
			<div align="center">
				<table align="center">
					<tr>
						<td width="30%">
			...
			<table align="center" width="500" border="0">
				<tr>
					<td width="50%" align="center">
						<font class="tituloAzulClaro">Reporte de Procesos Cargos Automáticos Simple (Rango de Fechas)</font>
	...
	<xsl:template name="DetalleAfiliados">
		<div align="center">
			<table align="center">
				<tr>
					...
					<td>
						<fONT class="tituloAzulClaro">CONSULTA DETALLADA PROCESOS DE CARGOS AUTOMATICOS</fONT>
					</td>
				</tr>
			</table>
		</div>
		...
		<xsl:for-each select="Resultado">
			<div width="100%" align="left">
				...
				<br/>
				<input class="button" type="button" onclick="tableToExcel('CA', 'CA')" value="Exportar a Excel"/>
			</div>
			<br/>
			<table id="CA" class="tabla" align="center" width="100%">
				<thead>
					<tr class="etiqueta">
