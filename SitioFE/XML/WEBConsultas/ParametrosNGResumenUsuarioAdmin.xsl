...
<xsl:stylesheet xmlns:a="http://tempuri.org/" exclude-result-prefixes="a soap" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/" version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/">
		<html>
			<head>
				<title>Bitacora de Pagos Usuario Administrador</title>
	...
	<xsl:template name="Consulta">
		<form action="Transaccion.aspx" method="post">
			...
			<input type="hidden" name="Admin" value="1000"/>
			<input type="hidden" name="Filtro" value="XML/WEBConsultas/ParametrosNGResumenUsuarioAdmin.xsl"/>
			<div align="center">
				<table align="center">
					<tr>
						<td width="30%">
			...
			<table align="center" width="500" border="0">
				<tr>
					<td width="50%" align="center">
						<font class="tituloAzulClaro">Consulta de Pagos Usuario Administrador</font>
						<br/>
						
						<font class="tituloAzulClaro"><xsl:value-of select="Sesion/CajaUsuario"/></font>
					</td>
				</tr>
			</table>
			<br/>
			
						<input type="hidden" name="FechaInicial"  class="Calendario"/>
				
					
						<input type="hidden"  name="FechaFinal"  class="Calendario"/>
			...
			<p>
				<div align="center">
					<font class="anuncio1">Unicamente se pueden reversar pagos del dia de HOY</font>
				</div>
			</p>
		</form>
	</xsl:template>
			...
			<table align="center">
				<tr>
					...
					<td>
						...
						<font class="tituloAzulClaro">Usuario Administrador : <xsl:value-of select="Resultado/Sesion/CajaUsuario"/></font>
					</td>
				</tr>
			</table>
		</div>
