		...
		<html>
			...
			<body>
				...
				<p align="center">
					...
					<td width="100%">
						<font class="tituloAzulClaro">Convenios del Sistema</font>
					</td>
				</p>
				...
				<xsl:choose>
					<xsl:when test="AgregaModificaConveniosFault">
						...
						<form action="Transaccion.aspx" method="post">
								...
								<input type="hidden" name="Filtro" value="XML/WEBConvenios/AgregarConvenio.xsl"/>
								<div align="center">
									<input name="BotonSalvar" class="button_red" type="submit" value="      Crear Convenio      "/>
										...
										<xsl:for-each select="ConsultaConveniosOutput/Resultado/Fila">
											<tr class="detalle">
												<td>
													<p align="center">
														<a>
															<xsl:attribute name="href">Transaccion.aspx?Transaccion=ConsultaConvenios&amp;Filtro=~/XML/WEBConvenios/ActualizarConvenio.xsl&amp;IDAlterno=<xsl:value-of select="IDAlterno"/>&amp;ID=<xsl:value-of select="ID"/></xsl:attribute>
