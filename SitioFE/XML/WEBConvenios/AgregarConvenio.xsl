...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template name="AgregarOutput">
		<form action="Transaccion.aspx">
			...
			<!-- -->
			<p>
				<div align="center" class="tituloAzulClaro">Información del Nuevo Convenio</div>
			</p>
        ...
        <tr>
          <td class="etiqueta">Cobro Tardio :</td>
          <td colSpan="3" class="detalle">
            <select class="campo" name="CobroTardio">
        ...
        <tr>
          ...
          <td colSpan="3" class="detalle">
            <select class="campo" name="Periodo">
              <xsl:for-each select="Resultado/Periodos/Fila">
        ...
        <tr>
          ...
          <td colSpan="3" class="detalle">
            <select class="campo" name="TipoPago">
              <xsl:for-each select="Resultado/TiposPago/Fila">
                <xsl:if test="Codigo='E'">
                  <option value="{Codigo}" selected="selected">
                    <xsl:value-of select="Descripcion"/>
                  </option>
                </xsl:if>
        ...
        <tr>
          <td class="etiqueta">Validar Antigüedad :</td>
          <td colSpan="3" class="detalle">
            <select class="campo" name="Antiguedad">
              <option value="N">NO</option>
              <option value="S">SI</option>
            </select>
          </td>
		 ...
		 <tr>
          ...
          <td colSpan="3" class="detalle">
            <select class="campo" name="Esquema">
