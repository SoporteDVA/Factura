...
<xsl:stylesheet xmlns:a="http://tempuri.org/" exclude-result-prefixes="a soap" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/" version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/">
		<html>
			<head>
				<title>Gestión de los tipo de identificadores asignados a cada colector y convenio del Sistema</title>
			...
			<body>
				...
				<p align="center">
					...
					<td width="100%">
						<font class="tituloAzulClaro">Tipo identificadores del Sistema</font>
					</td>
				</p>

				<xsl:choose>
					<xsl:when test="AgregaModificaTipoidsFault">
						<table class="tablaDetalle" align="center" border="0">
							...
							<tbody>
								...
								<xsl:for-each select="AgregaModificaTipoidsFault">
									<tr class="detalle">
						...
						<form action="Transaccion.aspx" method="post">
								...
								<input type="hidden" name="Filtro" value="XML/WEBTipoid/AgregarTipoid.xsl"/>
								<div align="center">
									<input name="BotonSalvar" class="button_red" type="submit" value="      Crear Tipo Identificador      "/>
							...
							<p>
								<table class="tablaDetalle" align="center" border="0">
									...
									<tbody>
										...
										<xsl:for-each select="ConsultaTipoidsOutput/Resultado/Fila">
											<tr class="detalle">
												<td>
													<p align="center">
														<a>
															<xsl:attribute name="href">Transaccion.aspx?Transaccion=ConsultaTipoids&amp;Filtro=~/XML/WEBTipoid/ActualizarTipoid.xsl&amp;ID=<xsl:value-of select="ID"/></xsl:attribute>
