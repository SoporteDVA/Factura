...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
			...
			<div align="center">
				...
				<table align="center" border="0">
					<tr>
						...
						<td width="100%">
							<font class="tituloAzulClaro">Gestión del Tipo de Identificador</font>
						</td>
					</tr>
				</table>
					<xsl:choose>
					<xsl:when test="ConsultaTipoidsOutput">
						<xsl:for-each select="ConsultaTipoidsOutput">
	...
	<xsl:template name="ConsultaOutput">
		<table class="tabla" align="center">
			...
			<tr>
				...
				<td class="detalle">
					<xsl:value-of select="Resultado/Fila/Convenio"/>
				</td>
			</tr>
	...
	<xsl:template name="Actualizar">
		<form action="Transaccion.aspx">
			...
			<!-- -->
			<div align="center" class="tituloAzulClaro">Editar Tipo de Identificador</div>
