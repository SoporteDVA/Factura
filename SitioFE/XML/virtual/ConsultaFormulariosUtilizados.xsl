		...
		<form action="Transaccion.aspx" method="post">
			...
			<table align="center" width="500" border="0">
				<tr>
					<!--<td width="50%">
								<p align="center">
									<img align="baseline" src="imagenes/dva.PNG" border="0" hspace="0" height="120" width="120"/>
								</p>
							</td>-->
				...
				<xsl:for-each select="Pagos/Fila">
					<tr>
						...
						<xsl:choose>
							...
							<xsl:when test="Estado='DE' or Estado='PE' or Estado='SVE'">
						...
						<td>
							<xsl:value-of select="CedulaAutorizado"/>--<xsl:value-of select="NombreAutorizado"/>
						</td>
						<td align="justify">
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\..\..\Compartida\PASEAPRODUCCIONMARCHAMOS\Marchamos\XML\CierreMasivoCajas\ConsultaCierreCajasDetallado.xml"
		          htmlbaseurl="..\..\..\..\Compartida\PASEAPRODUCCIONMARCHAMOS\Marchamos\XML\CierreMasivoCajas\192.168.1.9" outputurl="" processortype="saxon8" useresolver="yes" profilemode="4" profiledepth="" profilelength="" urlprofilexml=""
