				...
				<div align="center">
					...
					<table align="center" width="600" border="0">
						<tr>
							<td width="50%">
								<p align="center">
									<img align="baseline" src="imagenes/entrega.png" border="0" hspace="0" height="60" width="60"/>
								</p>
							</td>
							<td width="50%">
								<font class="tituloAzulClaro">Detalle de Pagos Remotos Entrega Sucursal</font>
							</td>
						</tr>
					</table>
				</div>
				...
				<div id="container">
					...
					<table class="tabla" align="center" cellpadding="0" cellspacing="0" border="0" id="pagos">
						...
						<tbody>
							...
							<xsl:for-each select="BitacoraCJDetalleSucursalOutput/Resultado/Fila">
								<tr class="odd gradeX">
									...
									<td align="center">
										<xsl:choose>
											...
											<xsl:when test="Estado='PG' or Estado='DG' or Estado='SVG'">
												<a href="Transaccion.aspx?Transaccion=BitacoraObtenerPagoSucursal&amp;UsuarioOrigen={Usuario}&amp;OficinaOrigen={Oficina}&amp;TipoComprobante={TipoComprobante}&amp;NumeroDocumento={NumeroDocumento}&amp;DiaPago={DiaPago}&amp;Filtro=XML/virtual/INSPagofromBitacoraEnvio.xsl">
													<xsl:value-of select="NumeroDocumento"/>
												</a>
											</xsl:when>
											<xsl:otherwise>
