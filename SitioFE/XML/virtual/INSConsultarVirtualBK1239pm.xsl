	...
	<xsl:template name="Consulta">
		<body onload="document.forms[0].NUMPLACA.focus();">
			<form action="Transaccion.aspx" method="post">
					...
					<tr>
						...
						<td colSpan="3">
							<select class="campo" name="CODGOBIERNO">
								...
								<option value="11">Temporal 2013</option>
								<option value="12">Temporal 2014</option>
							</select>
						</td>
					</tr>
					<!--<tr>
				...
				<br/>
				<div align="center">
					<input name="Consultar" class="button_blue" type="button" value="Consulta" onclick="if (document.forms[0].NUMPLACA.value == '') alert('Digite el número de placa.'); else submit();"/>
				</div>
			</form>
		</body>
	</xsl:template>
