				...
				<div align="center">
					...
					<table align="center" width="600" border="0">
						<tr>
							...
							<td width="50%">
								<font class="tituloAzulClaro">Detalle de Pagos Remotos Registrados</font>
							</td>
						</tr>
					</table>
				</div>
									...
									<td align="center">
										<xsl:choose>
											...
											<xsl:when test="Estado='PG' or Estado='DG' or Estado='SVG'">
												<a href="Transaccion.aspx?Transaccion=BitacoraObtenerPago&amp;UsuarioOrigen={Usuario}&amp;OficinaOrigen={Oficina}&amp;TipoComprobante={TipoComprobante}&amp;NumeroDocumento={NumeroDocumento}&amp;DiaPago={DiaPago}&amp;Filtro=XML/INS/INSPagofromBitacora.xsl">
													<xsl:value-of select="NumeroDocumento"/>
												</a>
											</xsl:when>
											<xsl:otherwise>
